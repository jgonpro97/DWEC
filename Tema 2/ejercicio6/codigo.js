/**
 * 6. El cálculo de la letra del Documento Nacional de Identidad (DNI) es un proceso matemático sencillo
 * que se basa en obtener el resto de la división entera del número de DNI y el número 23.
 ...
 * se muestra un mensaje al usuario diciéndole que la letra que ha indicado no es correcta. En otro caso, se muestra un 
...
{   
    ...
    let validarDni = function() {
        ...
        if (numeroDni < 0 || numeroDni > 99999999) {
            info.innerHTML = "Numero introducido no válido para DNI";
        }
    
        let valor = letras[numeroDni % 23];
    
        if (valor != letraDni) {
            info.innerHTML = "La letra introducida no es correcta";
        }
    
        else {
            info.innerHTML = "DNI introducido correcto";
        }
    }
